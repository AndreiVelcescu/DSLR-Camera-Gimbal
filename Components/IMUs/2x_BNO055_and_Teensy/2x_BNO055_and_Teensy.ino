...
//  delay(1000);
  ...
  /* Display some basic information on this sensor */
  displaySensorDetails(&bnoB);
  /* Optional: Display current status */
  displaySensorStatus(&bnoB);
...
{ digitalWrite(LED_BUILTIN, HIGH);  // turn the LED on (HIGH is the voltage level)
  ...
  delayMicroseconds(10000-(micros()-t));
...
//  Serial.println(micros()-t);
  ...
  // Serial.print("\t");
    ...
    // imu :: Vector<3> convertedAngles = quat.toEuler();
  // convertedAngles.toDegrees();

  // /* Display the floating point data */
  // Serial.print("\tX: ");
  // Serial.print(180 + convertedAngles.x());
  // Serial.print(" Y: ");
  // Serial.print(convertedAngles.y());
  // Serial.print(" Z: ");
  // Serial.print(convertedAngles.z());
  // Serial.println();
